...
enyo.kind({
    ...
    components:[
		...
		{name: 'gsv', kind: 'Image', src: 'assets/images/GSV_Logo.png', style: 'position:absolute; width: 16%; left: 2%; bottom: 2%'},
		{name: 'lsb', kind: 'Image', src: 'assets/images/Laborschule_Logo.png', style: 'position:absolute; width: 16%; right: 2%; bottom: 2%'}
